...
;function I(a,b,c){a||(a=$d);$d=null;var d=this.constructor.i||0,e=0<d,f=this.constructor.j,g=!1;if(!a){var h=f?[f]:[];ld(h,48);a=h;h=!0}else if(h=!!(nd(a)&16))g=nd(a),od(a,g|32),g=!!(g&32);e&&0<a.length&&Ad(a[a.length-1])&&"g"in a[a.length-1]&&(d=0);this.ma=(f?0:-1)-d;this.i=void 0;this.v=a;a:{f=this.v.length;d=f-1;if(f&&(f=this.v[d],Ad(f))){this.S=f;b=Object.keys(f);0<b.length&&jb(b,isNaN)?this.qa=Number.MAX_VALUE:this.qa=d-this.ma;break a}void 0!==b&&-1<b?(this.qa=Math.max(b,d+1-this.ma),this.S=
void 0):this.qa=Number.MAX_VALUE}if(!e&&this.S&&"g"in this.S)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');if(c)for(e=h&&!g?ud:td,b=0;b<c.length;b++)h=c[b],(g=Md(this,h))?Array.isArray(g)&&e(g):D(this,h,Cd,!1,!0)}
